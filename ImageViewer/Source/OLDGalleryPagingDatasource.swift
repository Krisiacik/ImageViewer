//
//  OLDGalleryPagingDatasource.swift
//  ImageViewer
//
...
final class OLDGalleryPagingDatasource: NSObject, UIPageViewControllerDataSource {
    
    private let imageControllerFactory: OLDImageViewControllerFactory
    private let imageCount: Int
    private let galleryPagingMode: GalleryPagingMode
    
    init(imageControllerFactory: OLDImageViewControllerFactory, imageCount: Int, galleryPagingMode: GalleryPagingMode) {
    ...
    func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
        ...
        guard let currentController = viewController as? OLDImageViewController else { return nil }
