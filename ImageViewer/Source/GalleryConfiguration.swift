...
public enum GalleryConfigurationItem {
    ...
    ///Transition duration for the blur layer of the overlay
    case BlurLayerDuration(NSTimeInterval)
    
    ///Transition delay for the blur layer of the overlay. The delay is against the moment when (reverse)displacement/fade starts.
    case BlurLayerDelay(NSTimeInterval)

    ///Transition duration for the color layer of the overlay
    case ColorLayerDuration(NSTimeInterval)

    ///Transition delay for the color layer of the overlay. The delay is against the moment when (reverse)displacement/fade starts.
    case ColorLayerDelay(NSTimeInterval)
    ...
    /// Duration of the displacement effect when gallery is being presented/dismissed.
    ...
    case OverlayAccelerationFactor(CGFloat)
