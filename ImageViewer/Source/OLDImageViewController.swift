...
final class OLDImageViewController: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate {
    ...
    /// DELEGATE
    weak var delegate: OLDImageViewControllerDelegate?
    ...
    init(itemsDatasource: GalleryItemsDatasource, displacedViewsDatasource: GalleryDisplacedViewsDatasource?, configuration: GalleryConfiguration, startIndex: Int,  imageIndex: Int, fadeInHandler: ImageFadeInHandler?, delegate: OLDImageViewControllerDelegate?) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(OLDImageViewController.adjustImageViewForRotation), name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    func configureGestureRecognizers() {
        ...
        singleTapRecognizer.addTarget(self, action: #selector(OLDImageViewController.scrollViewDidSingleTap(_:)))
        singleTapRecognizer.numberOfTapsRequired = 1
        scrollView.addGestureRecognizer(singleTapRecognizer)
        
        doubleTapRecognizer.addTarget(self, action: #selector(OLDImageViewController.scrollViewDidDoubleTap(_:)))
        doubleTapRecognizer.numberOfTapsRequired = 2
        scrollView.addGestureRecognizer(doubleTapRecognizer)
        
        singleTapRecognizer.requireGestureRecognizerToFail(doubleTapRecognizer)
        
        panGestureRecognizer.addTarget(self, action: #selector(OLDImageViewController.scrollViewDidSwipeToDismiss(_:)))
    ...
    func handleSwipeToDismissEnded(swipeOrientation: SwipeToDismiss, finalVelocity velocity: CGPoint, finalTouchPoint touchPoint: CGPoint) {
        ...
        let parentViewController = self.parentViewController as? OLDGalleryViewController
